...
my ($sales, $gross, $gross1, $gross2, $gross3, $gross4, $table1, $table2, $salesdiff1, $salesdiff2, $x, $z, $spX);
...
sleep 2;
for ($z=1; $z<3; $z++){
	print "Please enter the amount produced in sales for salesperson $z: \$\n";
	$spX = <STDIN>;
	chomp $spX;
	push @sales, $spX;
		if ($spX <= 0){
